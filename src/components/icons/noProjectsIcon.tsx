...
const NoProjectsIcon = ({ className }: ClassNameProp) => {
  return (
    <svg
      width="288"
      height="288"
    ...
    >
      <g clipPath="url(#clip0_15_619)">
        ...
        <g filter="url(#filter0_d_15_619)">
          <rect
            ...
            height="48"
            rx="4"
            transform="rotate(-5.99997 197.62 42.64)"
            fill="white"
            shapeRendering="crispEdges"
          />
          <path
            d="M224.993 73.4727L215.31 67.4518L216.821 66.0361L224.726 70.9366L231.44 64.4996L233.212 65.5703L224.993 73.4727ZM224.465 68.4503L214.782 62.4294L223.001 54.527L232.684 60.5479L224.465 68.4503ZM224.198 65.9143L229.452 60.8876L223.268 57.0631L218.015 62.0897L224.198 65.9143Z"
            fill="#0052CC"
          />
        </g>
      ...
      <defs>
        ...
        >
          ...
          <feColorMatrix
            type="matrix"
            values="0 0 0 0 0.0156863 0 0 0 0 0.105882 0 0 0 0 0.235294 0 0 0 0.05 0"
          />
          <feBlend
            mode="normal"
            in2="BackgroundImageFix"
